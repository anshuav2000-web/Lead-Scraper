...
export const LeadForm: React.FC<LeadFormProps> = ({ onSearch, isLoading }) => {
  ...
  return (
    <div className="bg-zinc-900/20 rounded-[2rem] md:rounded-[2.5rem] border border-zinc-800/40 overflow-hidden shadow-2xl">
      {/* Form Header */}
      ...
      <form onSubmit={handleSubmit} className="p-6 md:p-10">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-6 md:gap-8">
          ...
          <div className="space-y-2">
            ...
            <div className="relative">
              ...
              >
                <option value="all">Any Source (AI Optimized)</option>
        ...
        <div className="mt-10 flex flex-col sm:flex-row items-center justify-between gap-6">
           <div className="flex items-center gap-2">
              ...
              <p className="text-[10px] font-black text-zinc-600 uppercase tracking-widest">Gemini browsing live web intelligence</p>
           </div>
           
           <Button 
            type="submit" 
            isLoading={isLoading} 
            className="w-full sm:w-auto px-16 py-5 rounded-2xl md:rounded-[1.5rem] bg-gradient-to-r from-[#dc2626] to-[#e11d48] text-sm font-black uppercase tracking-widest shadow-2xl shadow-red-900/30"
           >
            Extract Leads
           </Button>
        </div>
